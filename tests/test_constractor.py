...
class TestToConstructor:
    ...
    def test_navigate_to_order_feed(self, prepare_for_constructor): # Убран browser
    ...
    def test_click_ingredient_displays_popup_with_details(self, prepare_for_constructor):
    ...
    def test_ingredient_popup_close(self, prepare_for_constructor):
        _, _, _, _, constructor, _ = prepare_for_constructor
        with allure.step('Открываем страницу с конструктором'):
            constructor.open()
    ...
    def test_counter_increments_when_ingredient_added(self, prepare_for_constructor):
        _, _, _, _, constructor, _ = prepare_for_constructor
        with allure.step('Открываем страницу с конструктором'):
            constructor.open()
    ...
    def test_user_can_place_order(self, prepare_for_constructor):
